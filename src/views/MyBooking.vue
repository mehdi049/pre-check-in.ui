        ...
        <div class="column is-9">
          ...
          <div id="main-content">
            ...
            <div class="columns is-multiline box is-mobile">
              ...
              <div class="column is-6">
                <div class="box-gray">
                  ...
                  <p class="has-text-grey">1x "Stoa-Helmat" Double Room</p>
                </div>
              </div>
              <div class="column is-6">
                <div class="box-gray">
                  ...
                  <p class="has-text-grey">2x adults</p>
                </div>
              </div>
              <div class="column is-12">
                <div class="box-gray">
            ...
            <div class="columns is-multiline box">
              ...
              <div class="column is-6">
                <figure class="image">
                  <img src="_assets/images/1407953244000-177513283.jpg" />
                </figure>
              </div>
              <div class="column is-6">
                <p>
                  <span class="has-text-weight-bold">Arrival:</span> Aug 2, 2021
                </p>
                <p>
                  <span class="has-text-weight-bold">Departure:</span> Aug 3,
                  2021
                </p>
